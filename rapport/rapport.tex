...
% TODO: article flex bison + site C++
...
la construction d'un compilateur avec Flex et Bison en C. Pour porter le code en % LA DOC !
...
ainsi que le langage de travail (C++ dans notre cas).\\ % TODO: reformuler
...
% TODO: dvlp sur les déclarations des tokens
