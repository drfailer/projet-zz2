...
utilisable dans le transpileur. À noter que pour l'utilisation du polymorphisme
avec une classe abstraite force l'utilisation de pointeurs et donc d'allocation
dynamique. Étant donné qu'il y a beaucoup d'objet à gérer et que nous n'avons
...
\subsection{La grammaire éléments du langages}
...
souhaitions aussi avoir les structures de contrôles présentes dans la plupart des
...
d'améliorer la précision des erreurs de syntaxe, en donnant plus d'indication à
...
revanche nous n'avons pas réussi à faire fonctionner les numéros de colonnes. Il
